...
class action_plugin_translate extends DokuWiki_Action_Plugin {
    ...
    public function handleInitLangByDomain(Doku_Event&$event,$param) {
        global $conf;
    ...
    public function handleInitLangByPageInfo(Doku_Event&$event,$param) {
        global $INFO,$ID,$conf;
        ...
        foreach ($langs as $lang) {
            ...
            $conf['available_lang'][] = array('text' => $this->helper->translationLink($lang,$text,false),'code' => $lang);
        }
    }
